...
local Window = Fluent:CreateWindow({
    Title = "KuroX Hub | Blox Fruits V1.0",
    SubTitle = "by LeThanhDat",
    TabWidth = 180,
...
----------Tween
 ...
 function Tween(Pos)
        ...
        pcall(function() tween = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart,TweenInfo.new(Distance/280, Enum.EasingStyle.Linear),{CFrame = Pos}) end)
        tween:Play()
...
function Click()
	if not _G.FastAttack then
		...
		local CombatFramework = debug.getupvalues(Module)[0.155]
...
--Create Tabs
    ...
    local ToggleMobAura = Tabs.Main:AddToggle("ToggleMobAura", {Title = "Farm Near Mob", Default = false })
...
CamShake:Stop()
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Bypass Tp [ Test ]", Default = false })
