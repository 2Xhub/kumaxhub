...
Website: tientiny.space
	...
	_G.Settings = {
		...
		Fruits = {
			...
			["Select Devil Fruits"] = {}, -- {"Bomb-Bomb","Spike-Spike","Chop-Chop","Spring-Spring","Kilo-Kilo","Spin-Spin","Kilo-Kilo","Spin-Spin","Bird: Falcon","Smoke-Smoke","Flame-Flame","Ice-Ice","Sand-Sand","Dark-Dark","Revive-Revive","Diamond-Diamond","Light-Light","Love-Love","Rubber-Rubber","Barrier-Barrier","Magma-Magma","Door-Door","Quake-Quake","Human-Human: Buddha","String-String","Bird-Bird: Phoenix","Rumble-Rumble","Paw-Paw","Gravity-Gravity","Dough-Dough","Shadow-Shadow","Venom-Venom","Control-Control","Soul-Soul","Dragon-Dragon","Kitsune-Kitsune"}
...
function TP2(P1)
    ...
    function Text(value)
		game.StarterGui:SetCore("SendNotification", {
			...
			Text = tostring(value),
			Icon = "http://www.roblox.com/asset/?id=16513855063",
			Duration = 10
		})
	end
...
SOMEXHUBMODILE.Name = "SOMEXHUBMODILE"
        ...
        MODILEMAGE.Image = "http://www.roblox.com/asset/?id=16513855063"
...
local LogoHub = Instance.new("ImageLabel")
	...
	LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(16513855063)

	local ScrollTab = Instance.new("ScrollingFrame")
	ScrollTab.Name = "ScrollTab"
	ScrollTab.Parent = Tab
	ScrollTab.Active = true
	ScrollTab.BackgroundColor3 = Color3.fromRGB(106, 90, 205)
	...
	function uitab:Tab(text,image)
		...
		function main:Button(text,callback)
			...
			TextBtn.Text = text
			TextBtn.TextColor3 = Color3.fromRGB(0, 225, 0)
...
local LogoToggle = Instance.new("ImageLabel")
	...
	LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(16513855063)
